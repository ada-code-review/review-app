...
3) Update `/constants.ts` with the teams' IDs (can be obtained with a GET request to `https://api.github.com/orgs/ada-code-review/teams/:team_name`).
